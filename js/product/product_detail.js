    ...
    container.innerHTML = `
        <section class="product-hero" >
            <div class="product-container" >
                ...
                <div class="product-lead product-lead--mobile">
                    <p class="product-category product-category--mobile">${escapeHtml(collectionLabel(product.collection))}</p>
                    <h1 class="product-title product-title--mobile">${product.name}</h1>
                </div>
                ...
                <div class="product-grid">
                    ...
                    <div class="product-info">
                        <div>
                            ...
                            <h1 class="product-title product-title--desktop">${product.name}</h1>
